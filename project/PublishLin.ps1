...
dotnet publish "./SPTarkov.Launcher/SPTarkov.Launcher.csproj" -c Release --self-contained false --framework net10.0 --runtime linux-x64 -p:PublishSingleFile=true
if (Test-Path -Path "./Build") { Remove-Item "./Build" -Recurse -Force }
New-Item -Path "./" -Name "Build" -ItemType "Directory"
Copy-Item "./SPTarkov.Launcher/bin/Release/net10.0/linux-x64/publish/SPTarkov.Launcher" "./Build/SPTarkov.Launcher.Linux"
