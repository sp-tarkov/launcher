...
public class Paths
{
    ...
    public static readonly string PatchPath = Path.Join("SPT_Runtime", "SPT_Data", "Launcher", "Patches");
    ...
    public static readonly string SptSettingsFolder = Path.Join("SPT_Runtime", "user", "sptsettings");
    public static readonly string SptAppDataFolder = Path.Join("SPT_Runtime", "user", "sptappdata");
