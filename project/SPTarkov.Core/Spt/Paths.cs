...
public class Paths
{
    ...
    public static readonly string ProtonPathUser = Path.Join(_userProfile, ".local", "share", "Steam", "compatibilitytools.d");
    public static readonly string ProtonPathSystem = Path.Join("/", "usr", "share", "steam", "compatibilitytools.d");
